...
wake_events / session_targets / wake_transport / wake_router / wake_dispatcher / wake_ledger / wake_persist / wake_reconcile
              Executive Wake Fabric.  PR-2 persists WAKE_REQUESTED and SOURCE_RESOLVED
              onto the existing Executive OS events table.  No scheduler, no SQLite
