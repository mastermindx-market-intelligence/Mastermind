...
Mandatory companion to `ACTIVE_EXECUTION.md` for substantial Web CEO or principal work that requires
principal-duty selection, direct-versus-delegate decisions, delegation economics, worker packets,
capacity-aware routing boundaries, or post-dispatch evidence consumption. Load it from the same
pinned Skillpack revision. ACTIVE_EXECUTION remains the sole active-turn, no-delta and finalization
owner, including capability-delta and lane-local-blocking law. This companion does not select a
