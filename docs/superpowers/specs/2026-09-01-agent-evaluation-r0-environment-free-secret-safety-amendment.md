...
6. **Email/personal account identity shapes** where the closed R0 contract forbids them.
7. **Private host/IP material** where a canonical R0 receipt forbids it, including loopback, link-local, RFC 1918 IPv4, and nonpublic IPv6 literals. Source-qualified public repository references and the canonical artifact-root abstraction are not private-host values.
