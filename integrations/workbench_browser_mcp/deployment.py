...
def create_browser_deployment(
    *,
    ...
    if (
        not callable(services.resolve_binding)
        or not callable(services.run_io)
        or not callable(services.clock_ms)
    ...
    codec = BrowserRefCodec(services.action_token_key)
...
__all__ = ["BrowserDeployment", "create_browser_deployment"]
