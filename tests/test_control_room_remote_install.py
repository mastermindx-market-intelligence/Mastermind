...
def test_remote_entrypoint_bootstraps_its_release_under_isolated_python():
    result = subprocess.run(
        [sys.executable, "-I", "-B", os.fspath(ROOT / "scripts" / "chairman_control_room_remote.py"), "--help"],
        cwd=ROOT,
        capture_output=True,
        text=True,
    )
...
@pytest.mark.parametrize("problem", ["dirty", "commit", "tree", "nonhex", "writable", "symlink", "hardlink"])
