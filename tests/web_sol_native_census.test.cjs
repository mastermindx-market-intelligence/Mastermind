...
const cap = {schema:'mastermind.web_sol_transport_capabilities.v1',protocol_major:1,
 package_version:'0.5.0',roles:['client','extension'],actions:['FOREGROUND','INSPECT','OBSERVE_CONTINUATION_ACK','SUBMIT_CONTINUATION','TYPED_REENTRY'],
...
function harness({count=1, queryFailure=false, pending=false, instance=INSTANCE, clock, postNative, mode, configPatch}={}) {
 ...
 clientPackageVersion:'0.5.0',nativePackageVersion:'0.5.0',extensionPackageVersion:'0.5.0',capabilityDigest:DIGEST,...configPatch};
