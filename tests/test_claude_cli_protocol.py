...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("nonfinite_json_number", "STREAM_JSON_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ...
        ("tool_result_num_lines_bool", "TOOL_RESULT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("tool_result_num_lines_float", "TOOL_RESULT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("tool_result_start_line_bool", "TOOL_RESULT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("tool_result_start_line_float", "TOOL_RESULT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("tool_result_total_lines_bool", "TOOL_RESULT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("tool_result_total_lines_float", "TOOL_RESULT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("tool_result_synthetic_type_invalid", "TOOL_RESULT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("tool_result_artifact_read_type_invalid", "TOOL_RESULT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("tool_result_truncation_type_invalid", "TOOL_RESULT_MISMATCH", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ...
        ("usage_uuid_type_invalid", "USAGE_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("usage_uuid_value_invalid", "USAGE_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ...
        ("result_queued_type_invalid", "RESULT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
        ("result_turn_count_bool", "TURN_COUNT_INVALID", ClaudeCliObservation.OUTCOME_UNRECONCILED),
